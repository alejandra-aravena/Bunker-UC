...
<html lang="es">
	<head>
    	...
    	<title>Bunker 2.0 - Asignar Encuestas</title>
  	</head>
    <body>
...
<?php include_once('../../includes/sidebar.php'); ?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="padding-bottom:0px;">
    	<h2 class="sub-header">Asignar encuestas a casos</h2>
        
        <div class="form-group">     
                <button type="button" class="btn btn-danger btn-sm" aria-label="CasosSinEncuesta" id="CasosSinEncuesta">
                    <span class="glyphicon glyphicon-cog" aria-hidden="true"></span>
                    Listar Casos sin encuesta
                </button>
    		</div>
      </div>
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="padding-top: 0px;">
        ...
        <form class="form-inline" onsubmit="return false">
            <div class="form-group">
                <label for="inicio" class="sr-only">Id inicio:</label>
           ...
           <div class="form-group">
                <label for="encuestasPosibles" class="sr-only">Encuesta</label>
                <select class="form-control" id="encuestasPosibles">
           ...
           <div class="form-group">     
                <button type="button" class="btn btn-success btn-sm" aria-label="Agregar Nuevo" id="agregarEC">
                    ...
                    Agregar Encuesta a varios casos
                </button>
    		</div>
       </form>
      </div>
      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style=" padding-top: 0;">
        ...
        <form class="form-inline" onsubmit="return false">
           ...
           <div class="form-group">
                <label for="encuestasPosibles2" class="sr-only">Encuesta</label>
                <select class="form-control" id="encuestasPosibles2">
                	<option>Encuesta...</option>
                </select>
           </div>
           <div class="form-group">     
                <button type="button" class="btn btn-warning btn-sm" aria-label="Agregar Nuevo" id="agregar1EC">
                    ...
                    Agregar una encuesta a un caso
                </button>
    		</div>
       </form>
      </div>
      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style=" padding-top: 0;">
        ...
        <form class="form-inline" onsubmit="return false">
          <div class="form-group">
                <label for="encuestasPosiblesVer" class="sr-only">Encuesta</label>
                <select class="form-control" id="encuestasPosiblesVer">
                	<option>Encuesta...</option>
                </select>
           </div>
           <div class="form-group">     
...
<script language="javascript" src="../../js/encuestasCasos.js"></script> 
