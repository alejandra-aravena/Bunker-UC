...
<html lang="es">
	<head>
    	...
    	<title>Bunker 2.0 - Casos Agendados</title>
  	</head>
    <body>
...
<?php include_once('../../includes/sidebar.php'); ?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    	<h2 class="sub-header">Casos Agendados</h2>
        ...
        <button type="button" class="btn btn-info btn-sm" aria-label="Descargar" id="descargarExcel">
            ...
            Descargar en Excel
                ...
                <button type="button" class="btn btn-danger btn-sm" aria-label="Eliminar" id="Eliminar">
                    ...
                    Eliminar archivos Excel por Caso Agendado del directorio
                </button>
    		</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="DescargarModalLabel">Descarga de Informes Excel por Caso Agendado</h4>
      </div>
      <div class="modal-body">
...
<div class="modal fade" id="EliminarModal" tabindex="-1" role="dialog" aria-labelledby="EliminarModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="EliminarModalLabel">Eliminación de Informes Excel por Caso Agendado</h4>
      </div>
      <div class="modal-body">
...
<script language="javascript" src="../../js/casosAgendados.js"></script>        
