...
<html lang="es">
	<head>
    	...
    	<title>Bunker 2.0 - Acciones</title>
  	</head>
    <body>
...
<?php include_once('../../includes/sidebar.php'); ?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    	<h2 class="sub-header">Acciones</h2>
...
<div class="modal fade" id="agregarModal" role="dialog" aria-labelledby="Agregar" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php include_once('agregarAccion.php'); ?>
...
<div class="modal fade" id="editarModal" role="dialog" aria-labelledby="editar" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php include_once('editarAccion.php'); ?>
...
<div class="modal fade" id="eliminarModal" role="dialog" aria-labelledby="editar" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php include_once('eliminarAccion.php'); ?>
