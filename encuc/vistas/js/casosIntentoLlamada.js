...
function cargarLista() {
	...
	$.ajax({
		type: "POST",
		url: "../../../controladores/casos/listarCasosIntentoLlamada.php",
		data: stringDatos,
		cache: false,
		beforeSend: function(){
...
$(document).ready(function() {
	...
	//Activar Menu
	$('li#casosIntentoLlamada').addClass('active');
...
$('#descargarExcel').on('click', function () {
	...
	$.ajax({
		type: "POST",
		url: "../../../controladores/descargas_excel/descargaExcelCasosIntentosLlamada.php",
		data: stringDatos,
		cache: false,
		beforeSend: function(){
			//$("#login").val('Conectando...');
...
$('#Eliminar').on('click', function () {
	...
	var stringDatos = ''
		...
		$.ajax({
			type: "POST",
			url: "../../../controladores/descargas_excel/elimnarExcelFilesCasosIntentosLlamada.php",
			data: stringDatos,
			cache: false,
			beforeSend: function(){
