...
$casos = new Casos();
$arrayCasos = $casos->getAllCasosIntentoLlamada();
$caso = array();
$i=0;
...
$objWriter->save(FOLDER_UPLOADS.'InformeCasosIntentosLlamada_'.$nombreProyecto.'_'.$hora.'.xls');

echo FOLDER_UPLOADS.'InformeCasosIntentosLlamada_'.$nombreProyecto.'_'.$hora.'.xls';
