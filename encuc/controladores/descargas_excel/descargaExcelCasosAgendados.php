...
$casos = new Casos();
$arrayCasos = $casos->getAllCasosWithAgenda();
...
$objWriter->save(FOLDER_UPLOADS.'InformeCasosAgendados_'.$nombreProyecto.'_'.$hora.'.xls');

echo FOLDER_UPLOADS.'InformeCasosAgendados_'.$nombreProyecto.'_'.$hora.'.xls';
